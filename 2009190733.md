...
public class MiniMusicCmdLine {
		...
		public static void main(String[] args){
			...
			if(args.length<2){
				//입력을 제대로 하지 않은 경우
				System.out.println("앙기와 음 높이를 지정하는 인자를 입력하세요");
			}
			else{
				
				//사용자로부터 입력받은 값으로 플레이어 입력
		...
		public void play(int instrument, int note){
			...
			try{
				...
				//track에 changeInstrument 이벤트 추가
