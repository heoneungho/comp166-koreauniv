...
//버튼 하나를 생성합니다. setOnClickListener를 이용해서 버튼을 클릭했을 때 생기는 사건을 정의합니다. 클릭이 되면 intent를 통해서 StartActivity로 넘어가게 합니다.
...
public class Guess {
		...
		public static int getWinner(String p1Value, String p2Value, String p3Value, String p4Value, String p5Value, final int rNumber) {
			...
			return winner;
		}//p1~5까지 가장 가까운 숫자를 비교해서 winner에 집어넣고 그 값을 return 합니다.이 클라스에서는 랜덤한 숫자를 생성하고 그숫자에 가장가까운사람을 선택합니다.
		...
		public static int getClosest(int p1Num, int p2Num, int p3Num, int p4Num, int p5Num,final int rNum) {
			...
			return closest;
		}//if구문을 거치면서 결정된 closest값을 리턴합니다.
...
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <EditText
        ...
        android:singleLine="true" />//player 1의 숫자입력값을 받습니다
    ...
    <EditText
        ...
        android:hint="@string/textHint"
        android:inputType="number"
        android:singleLine="true" />//player2의 숫자입력값을 받습니다
    <TextView
        ...
        android:textSize="24sp" />//player3의 숫자입력값을 받습니다
    ...
    <EditText
        ...
        android:hint="@string/textHint"
        android:inputType="number"
        android:singleLine="true" />//player4의 숫자입력값을 받습니다
    <TextView
    ...
    <EditText
        ...
        android:inputType="number"
        android:singleLine="true" />//player5의 숫자입력값을 받습니다
    <TextView
        ...
        android:layout_marginBottom="20dp"
        android:textSize="24sp" />//랜덤한 한숫자를 나타냅니다
    ...
    <TextView
        ...
        android:layout_centerHorizontal="true"
        android:textSize="24sp" />//가장가까운숫자를적은 winner를 표시합니다
    ...
    <Button
        ...
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"//모든 플레이어의 숫자입력이 끝나면 답에가장가까운사람을찾아내는 버튼
...
## 참조 ##
http://www.java2s.com/Open-Source/Android_Free_Code/Game_Guess/Download_Free_code_Guessing_Game.htm 코드를 따왔지만 player 5를 더 생성하고 메인 액티비티 전 시작 화면을 만들었습니다.
