...
public class Test
{
        ...
        public void crossFingers()
        {
                ...
                {
                        System.out.println("Aaargh!");//오류를 잡으면 메세지를 출력한다.
                        ex.printStackTrace();
                }
        }
        }
...
public class MiniMiniMusicApp
{
        public static void main(String[] args)
        {
                MiniMiniMusicApp mini = new MiniMiniMusicApp();//mini 객체를 만든다.
                mini.play();//mini객체에 대하여 play 메소드를 실행한다.
        }
        ...
        public void play()
        {
                try
                {
                        ...
                        //Sequence를 생성하면서 Sequence를 생성자로 넘겨준다.
                        
                        Track track = seq.createTrack();//Sequence에 track을 생성할 것을 요청한다..
                        
                        ShortMessage a = new ShortMessage();
                        a.setMessage(144, 1, 44, 100);
                        MidiEvent noteOn = new MidiEvent(a, 1);
                        track.add(noteOn); // track에 MidiEvent를 넣는다. 
                        
                        ShortMessage b = new ShortMessage();
                        b.setMessage(128, 1, 44, 100);
                        MidiEvent noteOff = new MidiEvent(b, 16);
                        track.add(noteOff); // track에 MidiEvent를 넣는다. 일종의 인스턴스변수이다.
                        ...
                        player.start();//Sequencer의 start()메소드를 부른다.
...
public class MiniMusicCmdLine //첫번째
{
        public static void main(String[] args)
        {
                ...
                {
                        int instrument = Integer.parseInt(args[0]);//악기를 설정한다.
                        int note = Integer.parseInt(args[1]);//노트를 설정한다.
        ...
        public void play(int instrument, int note)
        {
                try
                {
                        Sequencer player = MidiSystem.getSequencer();//sequencer를 생성한다.
                        player.open();//생성한 sequencer(player)를 연다.
                        Sequence seq = new Sequence(Sequence.PPQ,4);
                        Track track = seq.createTrack();//track을 생성한다.
                        
                        MidiEvent event = null;//event 생성하고 그 값을 null로 설정한다.
